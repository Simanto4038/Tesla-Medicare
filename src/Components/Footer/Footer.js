...
const Footer = () => {
  ...
  <footer
    ...
    <NavLink className='link' style={{fontWeight: "bold", fontSize:'16px',color:'white'}}
    activeStyle={{fontSize:'16px', fontWeight: "bold",color: "cyan"}} to="/facultis">Courses We Taught</NavLink >
    <NavLink  className='link' style={{fontWeight: "bold", fontSize:'16px',color:'white'}}
    activeStyle={{fontSize:'16px', fontWeight: "bold",color: "cyan"}} to="/Students">Students Service</NavLink >
    </Nav>
          </div>
