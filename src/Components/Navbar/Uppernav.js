...
const Uppernav = () => {
    ...
    <Navbar.Brand className='h6 ps-3' ><span> <i className="fas fa-phone-alt"></i>  247-30 (Emergency) <i className="fas fa-ambulance"></i> </span><i className="fas fa-arrow-circle-right"></i></Navbar.Brand>
    <Navbar.Toggle />
