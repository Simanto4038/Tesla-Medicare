...
const Login = () => {
  ...
  <Button type="submit" onClick={handleGitSignIn}  className='btn btn-dark ms-2' >LOG IN WITH <img src={gitlogo} style={{height:'20px',width:'20px'}} alt="" /></Button>
  <Button type="submit" onClick={handleFacebookSignIn}  className='btn btn-dark ms-2' >LOG IN WITH <img src={FBlogo} style={{height:'20px',width:'20px'}} alt="" /></Button>
